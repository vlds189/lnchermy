...
pub const APP_VERSION: &str = "3.0.17";
...
pub struct AppState {
    ...
    /// Whether the sidebar is pinned open (the ☰ toggle button). The width
    /// animates toward this flag; it is UI-only state, not persisted.
